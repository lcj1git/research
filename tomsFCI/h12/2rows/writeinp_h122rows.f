c23456------------------------------------------------------------------
      ...
      write(6,*) 'H', 2.0*x, 0.d0, 3.0*y, 'CustomH'
      write(6,*) 'H', x, 0.d0, y*2.0, 'CustomH'
      write(6,*) 'H', x*3.0, 0.d0, y*2.0, 'CustomH'
      write(6,*) 'H', 0.d0, 0.d0, y, 'CustomH'
      write(6,*) 'H', x*2.0, 0.d0, y, 'CustomH'
      write(6,*) 'H', -x, 0.d0, 0.d0, 'CustomH'
      write(6,*) 'H', x, 0.d0, 0.d0, 'CustomH'
      write(6,*) 'H', -2.0*x, 0.d0, -y, 'CustomH'
      write(6,*) 'H', 0.d0, 0.d0, -y, 'CustomH'
      write(6,*) 'H', -3.d0*x, 0.d0, -2.0*y, 'CustomH'
      write(6,*) 'H', -x, 0.d0, -2.0*y, 'CustomH'
      write(6,*) 'H', -2.d0*x, 0.d0, -3.0*y, 'CustomH'
      close(6)

...
set xtics 0.0, 1.0
set xtics add ("CX" 52.79861) 
set ytics add ( -4.85316 ) 
...
set xrange [*:*]
set yrange [*:*]
plot "ag2bu3/h10RHFE" u 1:3 w l ls 4 ti "RHF a@_g^2 b@_u^3",  \
     "ag3bu2/h10RHFE" u 1:3 w l ls 6 ti "RHF a@_g^3 b@_u^2"

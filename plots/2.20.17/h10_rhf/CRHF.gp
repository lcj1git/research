...
set title "Complex RHF Stability of H_{10}, Two Rows"
...
set xrange [45:85]
set yrange [*:*]
plot "ag2bu3/h10hess" u 1:4 w l ls 4 ti "RHF 1a@_g^2 2b@_u^2 3a@_g^2 4b@_u^2 5b@_u^2",  \
     "ag3bu2/h10hess" u 1:4 w l ls 6 ti "RHF 1a@_g^2 2b@_u^2 3a@_g^2 4b@_u^2 5a@_g^2" 

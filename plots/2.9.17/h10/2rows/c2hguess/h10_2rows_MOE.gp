...
set title "H_{10} Molecular Orbital Energies"
...
set output "h10_2rows_MOE.eps"
set xrange [0:*]
set yrange [*:*]
plot "h10_2rows_MOE" u 1:3 w l ls 1 ti "2^{nd}HOMO",  \
     "h10_2rows_MOE" u 1:4 w l ls 2 ti "HOMO",  \
     "h10_2rows_MOE" u 1:5 w l ls 3 ti "LUMO", \
     "h10_2rows_MOE" u 1:6 w l ls 4 ti "2^{nd}LUMO"

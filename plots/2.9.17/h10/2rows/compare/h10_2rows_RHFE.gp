...
set output "h10_2rows_RHFE.eps"
set xrange [0:*]
set yrange [*:*]
plot "h10_2rows_RHFE_nomix" u 2:3 w l ls 1 ti "no mixing",  \
     "h10_2rows_RHFE_mix" u 1:2 w l ls 2 ti "guess=mix"

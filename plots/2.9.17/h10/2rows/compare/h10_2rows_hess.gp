...
set title "H_{10} Hessian Eigenvalues"
set xlabel "y"
set ylabel "Omega (eV)"
set xtics 0, 0.5
...
set output "h10_2rows_hess.eps"
set xrange [0:*]
set yrange [*:*]
plot "h10_2rows_hess_nomix" u 2:3 w l ls 1 ti "RRHF",  \
     "h10_2rows_hess_nomix" u 2:4 w l ls 2 ti "CRHF",  \
     "h10_2rows_hess_nomix" u 2:5 w l ls 3 ti "RUHF",  \
     "h10_2rows_hess_mix" u 1:2 w l ls 4 ti "RRHF mix",  \
     "h10_2rows_hess_mix" u 1:3 w l ls 5 ti "CRHF mix",  \
     "h10_2rows_hess_mix" u 1:4 w l ls 6 ti "RUHF mix"

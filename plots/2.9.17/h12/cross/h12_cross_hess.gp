...
set title "H_{12} Hessian Eigenvalues"
...
set output "h12_cross_hess.eps"
set xrange [0:*]
set yrange [*:*]
plot "h12_cross_hess" u 1:3 w l ls 1 ti "RRHF",  \
     "h12_cross_hess" u 1:4 w l ls 2 ti "CRHF",  \
     "h12_cross_hess" u 1:5 w l ls 3 ti "RUHF"

...
set title "H_{8} Hessian Eigenvalues"
...
set output "h8_2rows_hess.eps"
set xrange [0:*]
set yrange [*:*]
plot "h8_2rows_hess" u 1:3 w l ls 1 ti "RRHF",  \
     "h8_2rows_hess" u 1:4 w l ls 2 ti "CRHF",  \
     "h8_2rows_hess" u 1:5 w l ls 3 ti "RUHF"

...
set xlabel "y (a_0)"
set ylabel "omega eV"
set title "H_6 Hessian Eigenvalues"
set xtics 0, 0.5
set x2tics (0.57735, 0.759836) format "" scale 0
set grid xtics x2tics ytics

set output "h6stability_rows.eps"
set xrange [*:*]
set yrange [*:*]
plot "h6rowsstability" u 1:2 w l ls 1 ti "RRHF",  \
     "h6rowsstability" u 1:3 w l ls 2 ti "CRHF",  \
     "h6rowsstability" u 1:4 w l ls 3 ti "RUHF"

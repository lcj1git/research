...
set title "H_6 Singlets"
set xtics 0, 0.5
set x2tics (0.57735, 0.759836) format "" scale 0
set grid xtics x2tics ytics

set output "h6singlet_rows.eps"
set xrange [*:*]
set yrange [*:*]
plot "h6rowssinglet" u 1:2 w l ls 1 ti "n=1",  \
     "h6rowssinglet" u 1:3 w l ls 2 ti "n=2",  \
     "h6rowssinglet" u 1:4 w l ls 3 ti "n=3"

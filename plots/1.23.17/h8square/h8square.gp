...
set title "H_8 Singlet States"
set xtics 0, 0.5
set x2tics (0.57735, 0.759836) format "" scale 0
set grid xtics x2tics ytics

set output "h8singlet_square.eps"
set xrange [*:*]
set yrange [*:*]
plot "h8squaresinglet" u 1:2 w l ls 1 ti "n=1",  \
     "h8squaresinglet" u 1:3 w l ls 2 ti "n=2",  \
     "h8squaresinglet" u 1:4 w l ls 3 ti "n=3"

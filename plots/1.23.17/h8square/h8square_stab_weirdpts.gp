...
set xlabel "y (a_0)"
set ylabel "omega eV"
set title "H_8 Hessian Eigenvalues"
set xtics 0, 0.025
set grid xtics ytics

set output "h8stability_square_weirdpts.eps"
set xrange [0.725:0.875]
set yrange [*:*]
plot "h8squarestab_weirdpts" u 1:2 ti "RRHF",  \
     "h8squarestab_weirdpts" u 1:3 ti "RUHF",  \
     "h8squarestab_weirdpts" u 1:4 ti "CRHF"

...
unset key
set xtics 0, 0.5
set x2tics (1.73) format "" scale 0
set grid xtics x2tics ytics

set output "H3.eps"
set xrange [0:6]
set yrange [*:0]
plot "Doublets1" u 1:2 w l ls 1 ti "S=1/2",  \
     "Doublets1" u 1:3 w l ls 2 ti "S=1/2",  \
     "Doublets1" u 1:4 w l ls 3 ti "S=1/2",  \
     "Doublets1" u 1:5 w l ls 4 ti "S=1/2",  \
     "Doublets1" u 1:6 w l ls 5 ti "S=1/2",  \
     "Doublets1" u 1:7 w l ls 6 ti "S=1/2",  \
     "Doublets1" u 1:8 w l ls 7 ti "S=1/2",  \
     "Doublets1" u 1:9 w l ls 8 ti "S=1/2"

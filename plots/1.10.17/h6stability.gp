...
set title "H6 Hessian Eigenvalues"
set xlabel "y (a_0)"
set ylabel "omega (eV)"
set xtics 0, 0.5
set grid xtics x2tics ytics

set output "h6stability.eps"
set xrange [0:3.5]
set yrange [*:*]
plot "h6stability" u 1:2 w l ls 1 ti "rrhf",  \
     "h6stability" u 1:3 w l ls 2 ti "crhf",  \
     "h6stability" u 1:4 w l ls 3 ti "ruhf"

...
set title "RHF MO Energies of H_{10}"
set xtics 0, 0.5
set x2tics (0.57735, 0.759836) format "" scale 0
set grid xtics x2tics ytics

set output "h10_2rows_RHFMOE.eps"
set xrange [*:*]
set yrange [*:*]
plot "h10_2rows_RHFMOE" u 1:2 w l ls 1 ti "2ndHOMO",  \
     "h10_2rows_RHFMOE" u 1:3 w l ls 2 ti "HOMO",  \
     "h10_2rows_RHFMOE" u 1:4 w l ls 3 ti "LUMO", \
     "h10_2rows_RHFMOE" u 1:5 w l ls 4 ti "2ndLUMO"

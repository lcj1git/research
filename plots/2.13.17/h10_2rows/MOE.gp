...
set title "RHF MO Energies of H_{10}, Two Rows"
set xlabel "{/Symbol a} (degrees)"
set ylabel "E (Hartree)"
set xtics 0, 5.0
set xtics add ("CX" 19.34) 
set xtics add ("CX" 37.44) 
set xtics add ("CX" 52.56) 
set xtics add ("CX" 70.66) 
...
set xrange [45:85]
set yrange [*:*]
plot "ag2bu3/h10MOE" u 1:6 w l ls 1 ti "HOMO-1",  \
     "ag2bu3/h10MOE" u 1:7 w l ls 2 ti "HOMO",  \
     "ag2bu3/h10MOE" u 1:8 w l ls 3 ti "LUMO",  \
     "ag2bu3/h10MOE" u 1:9 w l ls 4 ti "LUMO+1",  \
     "ag3bu2/h10MOE" u 1:6 w l ls 11 ti "HOMO-1",  \
     "ag3bu2/h10MOE" u 1:7 w l ls 12 ti "HOMO",  \
     "ag3bu2/h10MOE" u 1:8 w l ls 13 ti "LUMO",  \
     "ag3bu2/h10MOE" u 1:9 w l ls 14 ti "LUMO+1"

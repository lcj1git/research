...
set title "RHF Energy of H_{10}"
set xlabel "{/Symbol a} (degrees)"
set ylabel "E (Hartree)"
set xtics 0, 45.0
set grid xtics x2tics ytics

set output "h10RHFE_alpha225.eps"
set xrange [*:*]
set yrange [*:*]
plot "../mix/h10RHFE" u 1:3 w l ls 1 ti "guess=mix", \
     "h10RHFE" u 1:3 w l ls 2 ti "guess=read from {/Symbol a}=15"

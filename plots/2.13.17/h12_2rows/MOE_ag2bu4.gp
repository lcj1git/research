...
set title "RHF MO Energies of H_{12}, Two Rows, a_g^2b_u^4"
set xlabel "{/Symbol a} (degrees)"
set ylabel "E (Hartree)"
set xtics 0, 5.0 
set grid xtics x2tics ytics

set output "MOE_ag2bu4.eps"
set xrange [45:85]
set yrange [*:*]
plot "ag2bu4/h12MOE" u 1:3 w l ls 4 ti "2^{nd} HOMO",  \
     "ag3bu3/h12MOE" u 1:4 w l ls 6 ti "HOMO",  \
     "ag4bu2/h12MOE" u 1:5 w l ls 7 ti "LUMO",  \
     "ag4bu2/h12MOE" u 1:6 w l ls 8 ti "2^{nd} LUMO"

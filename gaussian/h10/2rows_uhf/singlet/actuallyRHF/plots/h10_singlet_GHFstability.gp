...
set title "H_{10} Singlet UHF to GHF Stability"
...
set output "h10_singlet_GHFstability.eps"
set xrange [5:85]
set yrange [*:*]
plot "follow23/h10hess" u 1:6 ls 1,  \
     "follow20/h10hess" u 1:6 ls 2,  \
     "test/follow37.5/h10hess" u 1:6 ls 3

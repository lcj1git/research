...
set output "../epss/combinedsingtrip2.eps"
set xrange [0.5:3.5]
set yrange [-3:*]
plot "../h6singlet" u 1:2 w l ls 1 ti "S=0, n=1",  \
     "../h6singlet" u 1:3 w l ls 2 ti "S=0, n=2",  \
     "../h6singlet" u 1:4 w l ls 3 ti "S=0, n=3",  \
     "../h6singlet" u 1:5 w l ls 4 ti "S=0, n=4",  \
     "../h6singlet" u 1:6 w l ls 5 ti "S=0, n=5",  \
     "../h6triplet" u 1:2 w l ls 6 ti "S=1, n=1",  \
     "../h6triplet" u 1:3 w l ls 7 ti "S=1, n=2",  \
     "../h6triplet" u 1:4 w l ls 8 ti "S=1, n=3",  \
     "../h6triplet" u 1:5 w l ls 9 ti "S=1, n=4",  \
     "../h6triplet" u 1:6 w l ls 10 ti "S=1, n=5"

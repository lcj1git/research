c23456------------------------------------------------------------------
      ...
      parameter (nlinefwd = 160)
      parameter (nlinebck = 157)
...
c rhf e
      ...
      open (5,file='fwd/h12hess')
      do i=nlinefwd,1,-1
       read(5,*) alpha(i), y(i), rrhf(i), crhf(i), ruhf(i)
      enddo
      close(5)
      open (5,file='bck/h12hess')
      ...
      open (5,file='fwd/h12MOE')
      do i=nlinefwd,1,-1
       read(5,*) alpha(i), y(i), eshomo(i), ehomo(i), elumo(i),
     & eslumo(i), egap(i)
      enddo
      close(5)
      open (5,file='bck/h12MOE')
      do i=nlinefwd+1,nline
       read(5,*) alpha(i), y(i), eshomo(i), ehomo(i), elumo(i),
     & eslumo(i), egap(i)
      enddo
     ...
     & eslumo(i), egap(i)
      ...
      open (5,file='fwd/h12RHFE')
      do i=nlinefwd,1,-1
       read(5,*) alpha(i), y(i), erhf(i)
      enddo
      close(5)
      open (5,file='bck/h12RHFE')
      do i=nlinefwd+1,nline
       read(5,*) alpha(i), y(i), erhf(i)
      enddo
      close(5)

...
c      alpha = 45.d0
     ...
     & stable(crhf) guess=read geom=nocrowd test'
      write(6,*) ''
      write(6,*) 'hf stability analysis of h12 triangular lattice,
     & y=',a,'alpha=',alpha
      write(6,*) ''
      write(6,*) '0 1'
      write(6,*) 'H'                                    !1
      ...
      write(6,*) 'H ','9 ',c,' 7 ',180.d0,' 2 ',0.d0     !11
      write(6,*) 'H ','10',c,' 8 ',180.d0,' 1 ',0.d0     !12
      write(6,*) 'H ','11',c,' 9 ',180.d0,' 2 ',0.d0     !13
      write(6,*) 'H ','12',c,'10 ',180.d0,' 1 ',0.d0     !14
      write(6,*) ''
      write(6,'(a)') '@H.gbs'
      write(6,*) ''
